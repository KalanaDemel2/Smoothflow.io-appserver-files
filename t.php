...
<html lang="en" class="no-js">
	<head>
		...
		<title>DuoWorld | For Connected Business</title>
...
<!--							<a href="#"><img src="img/logos/customizedLogo.png" alt="DuoWorld Logo"></a>-->
						</div>
					...
					<div class="row hero-content">
						<div class="col-md-12 text-center">
                            <img src="img/logos/duoWorldBanner_hero.png" alt="DuoWorld Logo">
							<h1 class="animated fadeInDown"><?php echo  $_SERVER['HTTP_HOST'].' Tenant Is Not Registed.' ?></h1>
							<?php if (isset($_COOKIE["securityToken"])){ ?>
								<a href="/tenant/registerTenant.php#/tenantinfo" class="use-btn animated fadeInUp">Register</a> 
							<?php } else { ?>
								<a href="s.php" class="use-btn animated fadeInUp">Sign in</a>
							<?php } ?>
                            <a href="http://duoworld.sossgrid.com" class="learn-btn animated fadeInUp">Learn more <i class="fa fa-arrow-down"></i></a>						</div>
					</div>
				</div>
			</section>
		</header>
<!-- 		<section class="video" id="about">
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						<h1><a href="https://www.youtube.com/watch?v=c-0oBrDlRu0&feature=youtu.be" class="youtube-media"><i class="fa fa-play-circle-o"></i> Watch the Video</a></h1>
					</div>
				</div>
			</div>
		</section>
					...
					<div class="col-md-6 nopadding features-intro-img">
						<div class="features-bg">
							...
							<div class="features-img wp1">
								<img src="img/logos/small-logo.png" alt="Logo">
							</div>
						</div>
					</div>
								...
								<div class="device-content">
									<div class="showcase-slider">
										<ul class="slides" id="showcaseSlider">
											<li>
												<img src="img/screen-4.jpg" alt="Device Content Image">
											</li>
											<li>
												<img src="img/screen-4.jpg" alt="Device Content Image">
											</li>
						...
						<div class="col-md-6">
							...
							<blockquote class="team-quote">
								...
								<div class="logo-quote">
									<a href=""><img src="img/logos/customizedLogo.png" alt="Logo"></a>
								</div>
							</blockquote>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center wp4">
						<h1>Seen Enough?</h1>
						<a href="http://duoworld.sossgrid.com/duoworld/frameworkEntry.html#/parentEntry/register" class="download-btn">Try it now<i class="fa fa-arrow-right"></i></a>
					</div>
				</div>
			</div>
		</section> -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						...
						<img src="img/logos/customizedLogo.png" alt="Footer Logo Blue">
						</h1>
						<p>© DuoWorld - <a href="">Licence</a> - Designed &amp; Developed by <a href="">Duo Software</a></p>
					</div>
					<div class="col-md-7">
						<ul class="footer-nav">
		...
		<div class="overlay overlay-boxify">
			<nav>
				...
				<ul>
					...
					<li><a href="http://duoworld.sossgrid.com/devstudio/"><i class="fa fa-download"></i>Develop Apps</a></li>
				</ul>
			</nav>
		</div>
